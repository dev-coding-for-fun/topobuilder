# web-local-topo-workflow Specification

## Purpose
Define the browser MVP workflow for creating, importing, editing, and reopening local Crags, Sectors, and Topos in the Expo web app.
